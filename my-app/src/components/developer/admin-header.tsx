    ...
    <AppBar position="relative" className="dashboard-header">
      <Toolbar disableGutters className="dashboard-header-container">
        ...
        >
          ...
          <Typography variant="h5" className="dashboard-header-title">
            Inquiry
          </Typography>
        </Box>
