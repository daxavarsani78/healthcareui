      ...
      <section className="privacy-list-section">
        <Box className="container">
          <Typography variant="h6" component="p" className="privacy-text title">
            ...
            CareCircuit Home and Disability Services Pty Ltd via the website
            located at www.ablelinkcare.com
          </Typography>
            ...
            <Box className="privacy-list-items">
              <Element name="section1" className="element">
                ...
                <Typography variant="h6" className="privacy-text">
                  &#40;a&#41; The Privacy Act 1988 &#40;Cth&#41; currently
                  defines “personal information” as meaning information or an
                  ...
                  and <br /> <br />
                  &#40;ii&#41; whether the information or opinion is recorded in
                  a material form or not. <br /> <br />
                  &#40;b&#41; If the information does not disclose your identity
                  or enable your identity to be ascertained, it will in most
                  cases not be classified as “personal information” and will not
              ...
              <Element name="section2" className="element">
                ...
                <Typography variant="h6" className="privacy-text">
                  ...
                  which we collect and hold about you may include: name, address
                  and contact details &#40;e.g. phone, email and fax&#41;.
                </Typography>
              </Element>
              <Element name="section3" className="element">
                ...
                <Typography variant="h6" className="privacy-text">
                  ...
                  whenever you input such information into the website. <br />{" "}
                  <br />
                  &#40;b&#41; We also collect cookies from your computer which
                  enable us to tell when you use the website and also to help
                  customise your website experience. As a general rule, however,
                  it is not possible to identify you personally from our use of
                  cookies.
                </Typography>
              </Element>
              <Element name="section4" className="element">
                ...
                <Typography variant="h6" className="privacy-text">
                  &#40;a&#41; The purpose for which we collect personal
                  information is to provide you with the best service experience
                  possible on the website. <br /> <br />
                  &#40;b&#41; We customarily disclose personal information only
                  to our service providers who assist us in operating the
                  website. Your personal information may also be exposed from
                  time to time to maintenance and support personnel acting in
                  the normal course of their duties. <br /> <br />
                  &#40;c&#41; By using our website, you consent to the receipt
                  of direct marketing material. We will only use your personal
                  information for this purpose if we have collected such
                  information direct from you, and if it is material of a type
                  which you would reasonably expect to receive from use. We do
                  not use sensitive personal information in direct marketing
                  activity. Our direct marketing material will include a simple
                  means by which you can request not to receive further
              ...
              <Element name="section6" className="element">
                ...
                <Typography variant="h6" className="privacy-text">
                  ...
                  by Chintan Patel and we may seek further information from you
                  to clarify your concerns. If we agree that your complaint is
                  well founded, we will, in consultation with you, take
                  appropriate steps to rectify the problem. If you remain
